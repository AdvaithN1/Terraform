...
public class LevelInterpreter : MonoBehaviour {
    ...
    public int availableCommands = 5;
    public int initialAvailableCommands = 5;

    public Text availableCommandsText;
    ...
    public void Start()
    {
        availableCommandsText.text = "Available Sudo Commands: " + availableCommands;
    ...
    public List<string> Interpret(string userInput) {
        ...
        if (args[0] == "sudo") {
            if (args[1] == "help") {
                ...
                response.Add("sudo restart - Restarts the level");
            } else if (args[1] == "move") {
                if (availableCommands == 0)
                {
                    response.Add("zsh: no more commands available");
                }
                else
                {
                    availableCommands--;
                    ...
                    if (obj != null)
                    {
                        ...
                        response.Add("You have "+availableCommands+" more available sudo commands.");
                    }
                    else
                    {
            ...
            response.Add("To modify game content, run a sudo command. You have " + availableCommands + " remaining.");
            response.Add("You can run \"sudo help\" for more details (Will not decrease your number of available commands).");
                // ...
        } 
        else {
