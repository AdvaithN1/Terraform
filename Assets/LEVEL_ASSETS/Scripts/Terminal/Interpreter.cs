...
public class Interpreter : MonoBehaviour {
    ...
    public bool godmodeUnlocked {get; set;}
    ...
    private void Update() {
        if (godmodeUnlocked) {
            if (Input.GetKeyDown(KeyCode.Z)) { // add temp platform
                cmdSound.Play();
            ...
            if (Input.GetKeyUp(KeyCode.Z)) { // destroy temp platform
                cmdSound.Play();
                AnimHandler.doCommand = true;
                AnimHandler.playerText.text = "$ sudo destroy UserB";
                StartCoroutine(zDestroy(currPlatform));
            }
            if (Input.GetKeyDown(KeyCode.LeftShift)) { // attack
                cmdSound.Play();
                AnimHandler.doCommand = true;
                AnimHandler.playerText.text = "$ atk amongus";
